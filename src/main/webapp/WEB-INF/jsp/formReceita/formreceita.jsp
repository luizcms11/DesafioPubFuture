          ...
          <div class="row justify-content-md-center mb-5 text-center">
              <div class="col-md-12 align-self-center text-center">
                ...
                <div class="form-group input-login mx-auto">
                    <input class="form-control money" id="valor" type="tel" placeholder="Valor em R$*" required="required" data-validation-required-message="Digite o Valor da Receita." />                            
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group input-login mx-auto">
                  <h6 style="margin-bottom:0px">Data de Recebimento:</h6>
                    <input class="form-control date-br" id="valor" type="date" placeholder="Data Recebimento"/>
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group input-login mx-auto">
                  <h6 style="margin-bottom:0px">Data de Recebimento Esperado:</h6>
                    <input class="form-control date-br" id="valor" type="date" placeholder="Data Recebimento Esperado" required="required" data-validation-required-message="Digite a data de Recebimento Esperado" />
                    <p class="help-block text-danger"></p>
                  </div>
                <div class="form-group input-login mx-auto">
